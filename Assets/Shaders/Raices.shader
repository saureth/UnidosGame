...
////// Emissive:
                ...
                float node_4902 = step(_Sombreado_var,dot(lightDirection,i.normalDir));
                float3 node_7959 = float3(0.4,0.4,0.4);
                float3 emissive = (_Fondo_var.rgb*(node_4902+node_7959));
