    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                UNITY_DEFINE_INSTANCED_PROP( float4, _ColorOutline)
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 _ColorOutline_var = UNITY_ACCESS_INSTANCED_PROP( Props, _ColorOutline );
                return fixed4(_ColorOutline_var.rgb,0);
            }
            ENDCG
        }
        Pass {
